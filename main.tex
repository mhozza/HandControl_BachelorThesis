...
%\usepackage{mathptmx}
%\usepackage[backend=biber,style=iso-authoryear,babel=other,bibencoding=UTF8]{biblatex} 
...
a pripomienky, priateľke, blízkym priateľom a rodine za morálnu podporu.
\end{minipage}
\end{center}
\hfill\mfauthor
\vfill\eject % EOP v
