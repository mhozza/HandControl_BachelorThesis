...
\subsection{Perceptron} \label{sect:perceptron}
...
%TODO ak sa zmeni implementacia na viac rekurentnych vrstiev, tak treba aj toto upravit
Trieda \textit{RecurrentNetwork} je potomkom triedy \textit{NeuralNetwork}. %Ako spodnú vrstvu používa 
\todo
