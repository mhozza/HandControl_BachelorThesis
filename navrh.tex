...
Pri rekurentných sieťach sme predkladali postupnosti obrázkov, pričom sme zachovávali poradie obrázkov v postupnosti. Rekurentné vstupy sme updatli len v prípade, že sme detekovali ruku. Po každej postupnosti sme rekurentné vstupy resetli na 0. Takto simulujeme správanie siete v reálnej aplikácii.

Pre testovacie účely sme na trénovanie používali menšiu sadu, ktorá mala ??? vstupov. %TODO
...
Na testovanie sme mali množinu ??? vstupov, ktoré sme nepoužívali na trénovanie. %TODO
